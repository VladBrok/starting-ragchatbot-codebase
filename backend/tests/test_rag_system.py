...
class TestRAGSystem:
    ...
    def test_query_successful_flow(self):
        ...
        # Mock AI response
        self.mock_ai_generator.generate_response.return_value = "Machine learning is a subset of AI..."
    ...
    def test_query_with_empty_sources(self):
        ...
        # Mock AI response
        self.mock_ai_generator.generate_response.return_value = "I couldn't find specific information about that topic."
        self.mock_tool_manager.get_last_sources.return_value = []
    ...
    def test_add_course_document_processing_error(self):
        ...
        self.mock_doc_processor.process_course_document.side_effect = Exception("Invalid file format")
    ...
    def test_add_course_folder_success(self, mock_listdir, mock_exists):
        ...
        mock_listdir.return_value = ["course1.pdf", "course2.docx", "readme.txt", "course3.txt"]
        ...
        test_chunks1 = [CourseChunk(content="Content 1", course_title="Course 1", chunk_index=0)]
        test_chunks2 = [CourseChunk(content="Content 2", course_title="Course 2", chunk_index=0)]
        test_chunks3 = [CourseChunk(content="Content 3", course_title="Course 3", chunk_index=0)]
    ...
    def test_conversation_flow_with_multiple_exchanges(self):
        ...
        assert second_call_args[1]["conversation_history"] == "User: First question\nAI: First response"
...
class TestRAGSystemErrorHandling:
    ...
    def test_query_tool_manager_exception(self):
        ...
        self.rag_system.tool_manager = Mock()
        self.rag_system.tool_manager.get_last_sources.side_effect = Exception("Tool error")
        self.rag_system.session_manager = Mock()
