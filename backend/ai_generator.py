...
"""
    ...
    def generate_response(self, query: str,
        ...
        return self._process_tool_rounds(messages, system_content, tools, tool_manager, max_rounds)
    ...
    def _process_tool_rounds(self, messages: List[Dict], system_content: str, 
                           tools: Optional[List], tool_manager, max_rounds: int = 2, current_round: int = 1) -> str:
        """
        ...
        updated_messages, tool_success = self._execute_round_tools(response, messages, tool_manager)
        ...
        return self._process_tool_rounds(updated_messages, system_content, tools, tool_manager, 
                                       max_rounds, current_round + 1)
    
    def _execute_round_tools(self, response, messages: List[Dict], tool_manager) -> Tuple[List[Dict], bool]:
        """
